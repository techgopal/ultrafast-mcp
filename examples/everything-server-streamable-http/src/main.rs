...
impl SamplingHandler for EverythingSamplingHandler {
    async fn create_message(&self, request: sampling::CreateMessageRequest) -> MCPResult<sampling::CreateMessageResponse> {
...
async fn main() -> anyhow::Result<()> {
    ...
    tracing_subscriber::fmt()
        .with_env_filter("info,ultrafast_mcp=debug,ultrafast_mcp_transport=debug,ultrafast_mcp_monitoring=debug")
        .with_target(false)
